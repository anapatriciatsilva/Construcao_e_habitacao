...
<html lang="pt">
    <head>
        ...
        <title>Home - Construção e Habitação</title>
                    ...
                    <div id="carousel-desktop" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-indicators">
                            ...
                            <?php foreach($carousel as $i => $c): ?>
                                ...
                                <button type="button" data-bs-target="#carousel-desktop" data-bs-slide-to="<?= $i; ?>" <?= ($i == 0) ? 'class="active" aria-current="true"' : ''; ?> class="d-block indicadores" aria-label="Slide <?= $i + 1; ?>"></button>
                        ...
                        <div class="carousel-inner">
                            ...
                            <?php foreach ($carousel as $i => $c): ?>
                                ...
                                <div class="carousel-item desktop <?= ($i == 0) ? "active" : ""; ?>">
                                    <img src="<?= $c["imagem"]; ?>" class="d-block w-100" alt="Home">
                                </div>
